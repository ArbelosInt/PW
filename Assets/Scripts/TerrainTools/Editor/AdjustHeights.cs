...
internal class AdjustHeights : ScriptableWizard
{
    ...
    private void OnWizardUpdate()
    {
        ...
        HeightAdjustment = Mathf.Clamp(HeightAdjustment, -1f * _terrainData.size.y, _terrainData.size.y);
        helpString = ("percentage of change is " + HeightAdjustment*100f/_terrainData.size.y + "%");
    }
    ...
    private void OnWizardCreate()
    {
        ...
        for (int y = 0; y < _terrainData.heightmapResolution; y++)
        {
            ...
            {
                heights[y, x] = heights[y, x] + HeightAdjustment/_terrainData.size.y;
            }
        }
